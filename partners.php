...
<section class="partners">			 
        <h2 class="partners__subtitle">НАШИ ПАРТНЕРЫ</h2>
        ...
        <ul class="partners__list">
              ...
              <li class="partners__item"><img class="partners__logo" src="<?php echo IMG_DIR; ?>/partners/killa-dnb.svg" alt="killa-dnb"></li>
              <li class="partners__item"><img class="partners__logo" src="<?php echo IMG_DIR; ?>/partners/hottour.svg" alt="hottour"></li>
              <li class="partners__item"><img class="partners__logo" src="<?php echo IMG_DIR; ?>/partners/naila.svg" alt="naila"></li>
